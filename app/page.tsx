  ...
  return (
    <section className="w-full max-w-4xl flex flex-col items-center gap-12 py-16 px-8 bg-white rounded-[3rem] shadow-xl shadow-pastelMint/40 relative">
      ...
      <div className="text-center space-y-6 mt-4">
        <h1 className="text-4xl md:text-5xl tracking-wide text-gray-800 leading-snug">
      ...
      <div className="flex gap-4 mt-8 mb-4">
        <Link href="/solutions" className="group flex items-center gap-3 px-12 py-6 bg-pastelPink text-white text-3xl rounded-full shadow-lg shadow-pastelPink/50 hover:bg-pink-400 hover:scale-105 transition-transform duration-200">
